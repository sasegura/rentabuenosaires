                ...
                <form onSubmit={handleSubmit} className="p-fluid">
                    ...
                    <div className='flex'>
                        <Field name="name" render={({ input, meta }) => (
                            <div className="p-field p-col-12 p-md-6">
                                <span className="p-float-label">
                                    <InputText id="name" {...input} className={'borderRadius2 '+classNames({ 'p-invalid': isFormFieldValid(meta) })} />
                        ...
                        <Field name="telefono" render={({ input, meta }) => (
                            <div className="p-field p-col-12 p-md-6">
                                <span className="p-float-label">
                                    <InputText id="telefono" {...input} className={'borderRadius2 '+classNames({ 'p-invalid': isFormFieldValid(meta) })} />
                    ...
                    <div >
                        <Field name="texto" render={({ input, meta }) => (
                            <div className="p-field  p-col-12">
                                <span className="p-float-label">
                                    <InputText id="texto" {...input} className={'borderRadius2 '+classNames({ 'p-invalid': isFormFieldValid(meta) })} />
