...
const EnviarMensaje = (props) => {
  ...
  const [error, setError]=useState('');
    ...
    return (
        ...
        <div
          id="enviar_mensaje"
          className="section section-contact-us text-center text-center ml-auto mr-auto col-md-8 col-lg-6"
        >
          <Container >
                ...
                <form onSubmit={handleSubmit} className="p-fluid">
                    ...
                    <div className='flex'>
                        <Field name="name" render={({ input, meta }) => (
                            <div className="p-field p-col-12 p-md-6">
                                <span className="p-float-label">
                                    <InputText id="name" {...input} autoFocus className={'borderRadius2 '+classNames({ 'p-invalid': isFormFieldValid(meta) })} />
                        ...
                        <Field name="telefono" render={({ input, meta }) => (
                            <div className="p-field p-col-12 p-md-6">
                                <span className="p-float-label">
                                    <InputText id="telefono" {...input} autoFocus className={'borderRadius2 '+classNames({ 'p-invalid': isFormFieldValid(meta) })} />
                        ...
                        <Field name="email" render={({ input, meta }) => (
                            <div className="p-field  p-col-12">
                                <span className="p-float-label p-input-icon-right">
                                    ...
                                    <InputText id="email" {...input} className={'borderRadius2 '+classNames({ 'p-invalid': isFormFieldValid(meta) })} />
                    ...
                    <div >
                        <Field name="texto" render={({ input, meta }) => (
                            <div className="p-field  p-col-12">
                                <span className="p-float-label">
                                    <InputText id="texto" {...input} autoFocus className={'borderRadius2 '+classNames({ 'p-invalid': isFormFieldValid(meta) })} />
                    ...
                    <div className="p-col-12 center text-center">
                      <Button type="submit" label={t("Enviar Mensaje")} className='p-button-rounded p-md-3'/>
                    </div></div>
                  </form>
            )} />
