...
import JSON from 'assets/json/datos.json';
...
const Tabla = (props) => {
    ...
    async function getPiso() {
        const url = '/pisos?filter[where][iddestino]=' + props.iddestino;
        try {
            const piso = await AxiosConexionConfig.get(url);
            setProduct(piso.data);
            console.log(product);
        } catch (e) {
            console.log(e);
        }
    ...
    useEffect(() => {
        getPiso();
    }, [props.iddestino]); // eslint-disable-line react-hooks/exhaustive-deps
    ...
    const header = (
        <div className="table-header">
            <h5 className="p-m-0">Gestionar Pisos</h5>
        ...
        <div className="datatable-crud-demo">
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={products} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    <Column field="idpiso" header="Identificador" sortable></Column>
