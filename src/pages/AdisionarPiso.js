    ...
    const pisoSelecionado=()=>{
        return(
            <div>
                ...
                <div>
                    {t("aireacondicionado")}{": "+piso.aireacondicionado}
                    <InputSwitch checked={aireacondicionado} onChange={(e) => setAireacondicionado(e.value)} />
                </div>
                <div>
                    {t("calefaccion")}{": "+piso.calefaccion}
                    <InputSwitch checked={calefaccion} onChange={(e) => setcalefaccion(e.value)} />
                </div>
                <div>
                    {t("cantbannos")}{": "+piso.cantbannos}     
                </div>
                <div>     
                    {t("cantpersonas")}{": "+piso.cantpersonas}
                </div>
                <div>     
                    {t("direccion")}{": "+piso.direccion}
                </div>
                <div>     
                    {t("metroscuadrados")}{": "+piso.metroscuadrados}
                </div>
                <div>
                    {t("tvcable")}{": "+piso.tvcable}
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation("translations")(AdisionarPiso));